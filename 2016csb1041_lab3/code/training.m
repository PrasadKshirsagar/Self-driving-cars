function [w1, w2, v, train_error, val_error] = training(X, Y, X_val, Y_val, num_epoch, learn_rate, batch_size, dropout)
...
for epoch = 1:num_epoch
    ...
    y1 = testing(X, w1, w2, v, dropout);
    y2 = testing(X_val, w1, w2, v, dropout);
